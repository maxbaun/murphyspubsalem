...
(function(e){e.fn.mobileMenu=function(t){var n={defaultText:"Navigate to...",className:"select-menu",subMenuClass:"sub-menu",subMenuDash:"–"},r=e.extend(n,t),i=e(this).find("ul");i.find("ul").addClass(r.subMenuClass);e("<select />",{"class":r.className}).insertAfter(e("#nav-right"));e("<option />",{value:"#",text:r.defaultText}).appendTo("."+r.className);i.find("a").each(function(){var t=e(this),n=" "+t.text(),i=t.parents("."+r.subMenuClass),s=i.length,o;if(t.parents("ul").hasClass(r.subMenuClass)){o=Array(s+1).join(r.subMenuDash);n=o+n}e("<option />",{value:this.href,html:n,selected:this.href==window.location.href}).appendTo("."+r.className)});e("."+r.className).change(function(){var t=e(this).val();if(t!=="#"&&typeof t!==undefined){window.location.href=e(this).val()}});e("."+r.className).val(r.defaultText).attr("selected","selected");return this}})(jQuery);
